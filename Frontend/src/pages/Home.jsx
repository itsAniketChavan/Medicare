          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div className="lg:w-[570px]">
              ...
              <p className="text__para">
                ...
                molestiae vitae nemo est sit odio itaque exercitationem.
                Praesentium velit voluptate officia, dignissimos, perspiciatis
                reprehenderit explicabo quaerat possimus perferendis, suscipit
                necessitatibus!
              </p>
              <button className="btn">Request an Appointed</button>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className="heading lg-text-center ">Our Medical Services</h2>
            <p className="text__para text-center">
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row ">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  2.Search for your Physian here, and contact their office.
                </li>
                <li className="text__para">
                  3.View our physicianswho are accepting new patients, use the
